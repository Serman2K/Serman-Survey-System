			...
			<div class="row">
				<div class="col-sm-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Enter your question here</label>
							<textarea name="question" id="" cols="20" rows="2" class="form-control"><?php echo isset($question)? $question: '' ?></textarea>
						</div>
						<div class="form-group">
							<label for="" class="control-label">Answer Type:</label>
